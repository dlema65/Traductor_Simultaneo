...
class Recorder:
    ...
    def play(self, audio):
        ...
        :param audio: audio a ser reproducido
        """
        # abre un stream de salida de audio
        stream = self._p.open(
            format=FORMAT,
            channels=CHANNELS,
            rate=RATE,
        ...
        # envía audio al stream de salida de audio
        stream.write(audio)
        # cierra y termina
        stream.close()
...
if __name__ == '__main__':
    ...
    recorder.save("../audio_prueba_video_3.wav")

    # prueba la reproducción
    recorder.play(phrase)
